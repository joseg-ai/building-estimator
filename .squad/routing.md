...
|-----------|----------|----------|
| Frontend / UI / forms / pages / SVG | Linus | New pages, components, layout, print/PDF, Tailwind |
| Backend / API / DB / auth | Rusty | New routes, schema migrations, persistence, login |
| Pricing / calc engine / catalog / domain models | Livingston | calculator.ts, catalog.ts, priceList.ts, types.ts, VBA→TS |
